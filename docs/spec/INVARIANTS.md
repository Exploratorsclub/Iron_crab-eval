...
- **On-Wire Contract:** `tests/request_reply_e2e_contract.rs`: ControlRequest → market-data → ControlResponse (request_id, target, terminal outcome ok|not_found|error). Externer Fehler weiterhin ueber RPC unreachable approximiert.
