...
- **Source-Contract (PR233 + Phase 2a/2b):** `tests/invariants_market_data_tracking_single_writer.rs` — `md_state_command_includes_flush_geyser_sync`; `phase2a_geyser_sync_on_track_worker_not_md_state_loop`; `phase2b_momentum_active_pools_bypasses_md_state`; `global_ingest_liveness_os_thread`; `touch_tracked_vault_o1_contract`.
